    ...
    { 
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            */
            ...
            //FLUENT API
            //modelBuilder.Entity<Person>().Property(temp => temp.TIN).HasColumnName("TIN").HasColumnType("varchar(8)").HasDefaultValue("ABC12345");
           ...
           // modelBuilder.Entity<Person>()
              //.HasCheckConstraint("CHK_TIN", "len([TaxIdenticationNumber]) = 8");

            //TABLE RELATIONS
            //MANUAL METHOD FOR ADDING A FOREIGN KEY; CAN ALSO BE DONE USING THE DATA ANNOTATIONS
